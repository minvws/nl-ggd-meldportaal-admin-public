...
//    'auditlog_full_request' => (bool)env('AUDIT_LOG_FULL_REQUEST', false),
//    'auditlog_to_syslog' => (bool)env('AUDIT_SYSLOG_ENABLED', false),
//    'auditlog_pubkey' => env('AUDIT_SYSLOG_THEIR_PUB_KEY', ''),
//    'auditlog_secret' => env('AUDIT_SYSLOG_OUR_PRIV_KEY', ''),
];
